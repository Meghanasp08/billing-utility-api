...
<body>
    ...
    async generateInvoicePDFLfi(data: any, mail: boolean = false) {
        ...
        // Generate PDF with header (without logo) and footer
        const pdfBuffer = await page.pdf({
            path: attachmentPath,
            format: 'A4',
            printBackground: true,
            displayHeaderFooter: true,
            headerTemplate: await this.header_template_lfi(),  // Use LFI-specific header without logo
            footerTemplate: await this.footer_template(),
            margin: {
                top: '45px',
                bottom: '100px',
    ...
    async header_template_lfi() {
        return `
    <div style="font-size:10px; margin:0; padding:0; width:100%; height:35px;">
    </div>
                `
    }
...
<body>
    <div class="container">
        <!-- Header with logo on the right - appears only on first page -->
        <div class="header-section">
            <div class="header-left">
                <h1>LFI STATEMENT OF FEES</h1>
                <h2>Collection Memo</h2>
            ...
            <div class="header-right">
                        <img style= top:0; right:0; width:250px; height:auto; margin:0; padding:0;  padding-right: 20px;" src='data:image/png;base64,'/>   
